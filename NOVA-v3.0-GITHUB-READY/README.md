...
For a full-repository Cloudflare Pages deployment, use `.` as the build output
directory; the root entry page forwards to `frontend/`. To deploy only the web
client, use `frontend` as the build output directory.
